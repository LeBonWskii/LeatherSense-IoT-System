...
#define NODE_NAME_JSON "{\"name\":\"actuator_locker\",\"status\":\"off\"}"
...
// Declare resource defined in resources/resource_locker.c
extern coap_resource_t res_locker;
...
// Process declaration
PROCESS(actuator_locker, "Actuator locker");
AUTOSTART_PROCESSES(&actuator_locker);

/*
* This process is used to register the actuator to the server
* and to activate the resource "locker"
* 
...
*/
PROCESS_THREAD(actuator_locker, ev, data){
