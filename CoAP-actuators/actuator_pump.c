...
#define NODE_NAME_JSON "{\"name\":\"actuator_pump\",\"status\":\"off\"}"
...
// Declare resource defined in resources/resource_pump.c
extern coap_resource_t res_pump;
...
* and to activate the resource "pump"
* 
...
*/
PROCESS_THREAD(actuator_pump, ev, data){
